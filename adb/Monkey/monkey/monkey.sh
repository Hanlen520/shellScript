...
#系统事件占比10%
logcat -c  #清除日志
monkey -p com.yixia.xg --throttle 300 -s 82  -v -v -v  --pct-appswitch 20 --pct-majornav 10 --pct-touch 30 --pct-syskeys 10 --pct-motion 25 --pct-nav 5 20000 > /sdcard/monkey/monkey.log
echo  "-----------------------mongkey结束运行时间：-----------------------" >> /sdcard/monkey/monkey.log
date >> /sdcard/monkey/monkey.log
